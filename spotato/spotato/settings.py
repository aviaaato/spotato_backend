"""
Django settings for spotato project.
...
SECRET_KEY = 'django-insecure-@x*yp&o$*akj%zumy3h@yif9^mkltx@1cc%r89zjiwlg6$24y+'
...
INSTALLED_APPS = ['django.contrib.admin', 'django.contrib.auth', 'django.contrib.contenttypes',
    ...
    'rest_framework.authtoken', 'rest_framework', 'spotato_app', ]
...
WSGI_APPLICATION = 'spotato.wsgi.application'

# Database
# https://docs.djangoproject.com/en/4.1/ref/settings/#databases

DATABASES = {'default': {'ENGINE': 'django.db.backends.sqlite3', 'NAME': BASE_DIR / 'spotato_db.db', }}
